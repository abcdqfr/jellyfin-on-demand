...
using Jellyfin.Plugin.Swarmplay.EventHandlers;
using Jellyfin.Plugin.Swarmplay.Services;
using Jellyfin.Plugin.Swarmplay.ScheduledTasks;
...
namespace Jellyfin.Plugin.Swarmplay
{
    public class PluginServiceRegistrator : IPluginServiceRegistrator
    {
        public void RegisterServices(IServiceCollection serviceCollection, IServerApplicationHost applicationHost)
        {
            ...
            serviceCollection.AddSingleton<ISwarmSession>(_ => NativeSwarmSession.CreateOrStub());
