...
(function() {
    ...
    window.JellyfinEnhanced = {
        ...
        // (/Swarmplay/cdn/{source}/{path}) — backed by an on-disk cache refreshed
        ...
        cdn: {
            ...
            url(source, path) {
                ...
                return ApiClient.getUrl(`/Swarmplay/cdn/${source}/${clean}`);
            },
    ...
    async function loadTranslationsModule() {
        ...
        await new Promise((resolve) => {
            ...
            script.src = ApiClient.getUrl(`/Swarmplay/js/enhanced/translations.js?v=${getScriptVersion()}`);
     ...
     */
     function loadPluginData() {
        const configPromise = ApiClient.ajax({
            type: 'GET',
            url: ApiClient.getUrl('/Swarmplay/public-config'),
            dataType: 'json'
        }).catch((e) => {
        ...
        const versionPromise = ApiClient.ajax({
            type: 'GET',
            url: ApiClient.getUrl('/Swarmplay/version'),
            dataType: 'text'
        }).catch((e) => {
    ...
    async function loadPrivateConfig() {
        try {
            const privateConfig = await ApiClient.ajax({
                type: 'GET',
                url: ApiClient.getUrl('/Swarmplay/private-config'),
                dataType: 'json'
            });
     ...
     */
     function loadSplashScreenEarly() {
        ...
        splashScript.src = ApiClient.getUrl('/Swarmplay/js/others/splashscreen.js?v=' + getScriptVersion());
        splashScript.onload = () => {
    ...
    function loadLoginImageEarly() {
        ...
        ApiClient.ajax({
            ...
            if (config?.EnableLoginImage === true) {
                ...
                loginImageScript.src = ApiClient.getUrl('/Swarmplay/js/extras/login-image.js?v=' + getScriptVersion());
    ...
    async function initialize() {
        ...
        try {
            ...
            const fetchPromises = [
                ApiClient.ajax({ type: 'GET', url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/settings.json?_=${Date.now()}`), dataType: 'json' })
                         .then(data => ({ name: 'settings', status: 'fulfilled', value: data }))
                         .catch(e => ({ name: 'settings', status: 'rejected', reason: e })),
                ApiClient.ajax({ type: 'GET', url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/shortcuts.json?_=${Date.now()}`), dataType: 'json' })
                         .then(data => ({ name: 'shortcuts', status: 'fulfilled', value: data }))
                         .catch(e => ({ name: 'shortcuts', status: 'rejected', reason: e })),
                ApiClient.ajax({ type: 'GET', url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/bookmark.json?_=${Date.now()}`), dataType: 'json' })
                         .then(data => ({ name: 'bookmark', status: 'fulfilled', value: data }))
                         .catch(e => ({ name: 'bookmark', status: 'rejected', reason: e })),
                ApiClient.ajax({ type: 'GET', url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/elsewhere.json?_=${Date.now()}`), dataType: 'json' })
                         .then(data => ({ name: 'elsewhere', status: 'fulfilled', value: data }))
                         .catch(e => ({ name: 'elsewhere', status: 'rejected', reason: e })),
                ApiClient.ajax({ type: 'GET', url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/hidden-content.json?_=${Date.now()}`), dataType: 'json' })
