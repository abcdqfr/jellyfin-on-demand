    ...
    JE.showEnhancedPanel = async () => {
        ...
        if (currentUserId) {
            try {
                ...
                const settingsResponse = await ApiClient.ajax({
                    type: 'GET',
                    url: ApiClient.getUrl(`/Swarmplay/user-settings/${currentUserId}/settings.json?_=${Date.now()}`),
                    dataType: 'json'
                });
        ...
        if (displayLanguageSelect) {
            ...
            (async () => {
                ...
                try {
                    const [localeCodes, cultures] = await Promise.all([
                        ApiClient.ajax({ type: 'GET', url: ApiClient.getUrl('/Swarmplay/locales'), dataType: 'json' }),
            ...
            displayLanguageSelect.addEventListener('change', async (e) => {
                ...
                // All dropdown options come from /Swarmplay/locales, so they are guaranteed valid
