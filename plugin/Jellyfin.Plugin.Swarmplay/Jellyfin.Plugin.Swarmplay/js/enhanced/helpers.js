...
(function(JE) {
    ...
    // Seerr avatar URLs are proxied through /Swarmplay/proxy/avatar, which requires the
    ...
    /**
     * Resolve a protected avatar URL (our /Swarmplay/proxy/avatar path) to a blob object
    ...
    async function resolveProtectedAvatarUrl(avatarUrl) {
        ...
        if (!avatarUrl.startsWith('/Swarmplay/proxy/avatar')) return avatarUrl;
