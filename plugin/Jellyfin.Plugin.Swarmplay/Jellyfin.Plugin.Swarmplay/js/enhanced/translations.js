...
(function(JE) {
    ...
    async function getPluginVersion() {
        ...
        try {
            const versionResponse = await fetch(ApiClient.getUrl('/Swarmplay/version'));
    ...
    async function tryLoadSingleLanguage(code, pluginVersion) {
        ...
        try {
            const bundledResponse = await fetch(ApiClient.getUrl(`/Swarmplay/locales/${code}.json`));
        ...
        console.log(`🪼 Jellyfin Enhanced: Loading bundled translations for ${code}...`);
        let response = await fetch(ApiClient.getUrl(`/Swarmplay/locales/${code}.json`));
        ...
        response = await fetch(ApiClient.getUrl('/Swarmplay/locales/en.json'));
        if (response.ok) {
