...
(function (JE) {
    ...
    async function refresh() {
        try {
            ...
            const fresh = await ApiClient.ajax({
                type: 'GET',
                url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/hidden-content.json?_=${Date.now()}`),
                dataType: 'json'
            });
    ...
    async function fetchHiddenContentUsers() {
        try {
            const res = await ApiClient.ajax({
                type: 'GET',
                url: ApiClient.getUrl('/Swarmplay/admin/hidden-content-users'),
                dataType: 'json'
            });
    ...
    async function fetchUserHiddenItemsForAdmin(targetUserId) {
        ...
        try {
            const res = await ApiClient.ajax({
                type: 'GET',
                url: ApiClient.getUrl(`/Swarmplay/admin/hidden-content/${targetUserId}`),
                dataType: 'json'
            });
    ...
    async function adminUnhideForUser(targetUserId, keys) {
        ...
        try {
            await ApiClient.ajax({
                type: 'POST',
                url: ApiClient.getUrl(`/Swarmplay/admin/hidden-content/${targetUserId}/unhide`),
    ...
    async function adminHideForUser(targetUserId, items) {
        ...
        try {
            const res = await ApiClient.ajax({
                type: 'POST',
                url: ApiClient.getUrl(`/Swarmplay/admin/hidden-content/${targetUserId}/hide`),
    ...
    async function directSaveHiddenContent() {
        ...
        await ApiClient.ajax({
            type: 'POST',
            url: ApiClient.getUrl(`/Swarmplay/user-settings/${userId}/hidden-content.json`),
            data: snapshot,
            contentType: 'application/json'
        });
        return snapshot;
