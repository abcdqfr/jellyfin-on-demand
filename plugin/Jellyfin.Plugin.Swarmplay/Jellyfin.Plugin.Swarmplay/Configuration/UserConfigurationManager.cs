...
namespace Jellyfin.Plugin.Swarmplay.Configuration
{
    ...
    public class UserConfigurationManager
    {
        ...
        {
            _configBaseDir = Path.Combine(appPaths.PluginsPath, "configurations", "Jellyfin.Plugin.Swarmplay");
        ...
        public void SaveUserConfiguration(string userId, string fileName, object config)
        {
            ...
            try
            {
                ...
                if (string.Equals(fileName, Jellyfin.Plugin.Swarmplay.Services.SpoilerBlurImageFilter.SpoilerBlurFileName, StringComparison.OrdinalIgnoreCase))
                {
                    Jellyfin.Plugin.Swarmplay.Services.SpoilerUserResolver.InvalidateUser(userId);
                }
            }
            catch (Exception ex)
            {
