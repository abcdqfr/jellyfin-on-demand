...
namespace Jellyfin.Plugin.JellyfinOnDemand.Services
{
    ...
    /// from the plugin's own <c>/JellyfinOnDemand/cdn/{source}/{path}</c> route,
    ...
    public class CdnAssetService
    {
        ...
        public CdnAssetService(Logger logger, IHttpClientFactory httpClientFactory, IApplicationPaths applicationPaths)
        {
            ...
            _cacheDir = Path.Combine(applicationPaths.PluginsPath, "configurations", "Jellyfin.Plugin.JellyfinOnDemand", "cdn-cache");
        }
