...
using Jellyfin.Plugin.JellyfinOnDemand.EventHandlers;
using Jellyfin.Plugin.JellyfinOnDemand.Services;
using Jellyfin.Plugin.JellyfinOnDemand.ScheduledTasks;
...
namespace Jellyfin.Plugin.JellyfinOnDemand
{
    public class PluginServiceRegistrator : IPluginServiceRegistrator
    {
        public void RegisterServices(IServiceCollection serviceCollection, IServerApplicationHost applicationHost)
        {
            ...
            // Seerr/TMDB calls.
            // JellyfinOnDemand: quarantined ADR-004
