...
namespace Jellyfin.Plugin.JellyfinOnDemand.Configuration
{
    ...
    public class PluginConfiguration : BasePluginConfiguration
    {
        public PluginConfiguration()
        {
            ...
            // JellyfinOnDemand P2-03
            JellyfinOnDemandDiscoveryEnabled = true;
            TorznabNyaaUrl = "";
            TorznabTpbUrl = "";
            RankMinSeeders = 3;
            ...
            // Seerr Search Settings — JellyfinOnDemand: leave disabled (ADR-004). Scripts not loaded.
            JellyseerrEnabled = false;
            // True: JellyfinOnDemand discovery uses this chrome (TMDB). Seerr process still off.
            ...
            JellyseerrShowQuotaInfo = false;
            JellyseerrShowSimilar = false;
            JellyseerrShowRecommended = false;
            JellyseerrShowRequestMoreOnSeries = false;
            JellyseerrShowNetworkDiscovery = false;
            JellyseerrShowGenreDiscovery = false;
            JellyseerrShowTagDiscovery = false;
            JellyseerrShowPersonDiscovery = false;
            JellyseerrShowCollectionDiscovery = false;
            JellyseerrShowDetailPageLink = false;
        ...
        // JellyfinOnDemand P2-03
        public bool JellyfinOnDemandDiscoveryEnabled { get; set; }
        public string TorznabNyaaUrl { get; set; }
        public string TorznabTpbUrl { get; set; }
        public int RankMinSeeders { get; set; }
        public string RankPreferMaxResolution { get; set; }
        public int WarmTailMib { get; set; }
        public int WarmHeadMib { get; set; }
