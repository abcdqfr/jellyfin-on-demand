...
namespace Jellyfin.Plugin.JellyfinOnDemand.Configuration
{
    ...
    public class UserConfigurationManager
    {
        ...
        {
            _configBaseDir = Path.Combine(appPaths.PluginsPath, "configurations", "Jellyfin.Plugin.JellyfinOnDemand");
        ...
        public void SaveUserConfiguration(string userId, string fileName, object config)
        {
            ...
            try
            {
                ...
                if (string.Equals(fileName, Jellyfin.Plugin.JellyfinOnDemand.Services.SpoilerBlurImageFilter.SpoilerBlurFileName, StringComparison.OrdinalIgnoreCase))
                {
                    Jellyfin.Plugin.JellyfinOnDemand.Services.SpoilerUserResolver.InvalidateUser(userId);
                }
            }
            catch (Exception ex)
            {
