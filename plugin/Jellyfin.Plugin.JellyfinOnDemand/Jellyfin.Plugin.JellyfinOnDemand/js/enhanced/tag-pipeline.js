...
(function(JE) {
    ...
    async function loadServerCache() {
        ...
        try {
            ...
            const resp = await ApiClient.ajax({
                type: 'GET',
                url: ApiClient.getUrl(`/JellyfinOnDemand/tag-cache/${userId}`),
                dataType: 'json'
            });
    ...
    async function refreshServerCache() {
        ...
        try {
            ...
            const resp = await ApiClient.ajax({
                type: 'GET',
                url: ApiClient.getUrl(`/JellyfinOnDemand/tag-cache/${userId}?since=${serverCacheTimestamp}`),
                dataType: 'json'
            });
    ...
    async function processBatch(batch, generation) {
        ...
        try {
            ...
            const response = await ApiClient.ajax({
                type: 'POST',
                url: ApiClient.getUrl(`/JellyfinOnDemand/tag-data/${userId}`),
