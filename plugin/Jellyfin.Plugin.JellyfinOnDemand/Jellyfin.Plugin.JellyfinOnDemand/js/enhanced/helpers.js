...
(function(JE) {
    ...
    // Seerr avatar URLs are proxied through /JellyfinOnDemand/proxy/avatar, which requires the
    ...
    /**
     * Resolve a protected avatar URL (our /JellyfinOnDemand/proxy/avatar path) to a blob object
    ...
    async function resolveProtectedAvatarUrl(avatarUrl) {
        ...
        if (!avatarUrl.startsWith('/JellyfinOnDemand/proxy/avatar')) return avatarUrl;
